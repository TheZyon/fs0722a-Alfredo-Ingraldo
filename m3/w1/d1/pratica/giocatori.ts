...
function tombolinaCheapDiMariello(): void {
            ...
            setTimeout(function () {
                ...
                setTimeout(function () {
                    if (giocatore1 == rnd || giocatore2 == rnd) {
                        ...
                        atteseInutili();
                        setTimeout(function () {if (giocatore1 == rnd) {
                            console.log("giocatore 1 ha vinto sessione");
                        } else { console.log("giocatore 2 ha vinto sessione") } }, 1200);    
                    }
                    else {
