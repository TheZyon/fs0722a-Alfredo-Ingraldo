import { GestioneDatiUtente, testo } from "./classi.js";
        ...
        if (typeof (u) != 'string') {
            ...
            if (divFond != null) { //carica le opzioni la gestione dell'account
                ...
                numero404Inp.querySelector("button")?.addEventListener("mousedown", function () {
                    if (out != null) {
                        out.innerHTML = `possiedi: ${utente.carica}`;
                    }
                    else {
                ...
                numeroChiamateInp?.querySelector("button")?.addEventListener("mousedown", function () {
                    if (out != null) {
                        out.innerHTML = `hai fatto: ${utente.numeroChiamate} chiamate`;
                    }
                    else {
                        console.log("out not found in dom");
                    }
            ...
            console.log("divFond not found in DOM");
        }
    }
    else {
        console.log(u);
